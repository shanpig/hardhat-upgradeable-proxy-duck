...
contract RubberDuckBathParty is ERC721Upgradeable, OwnableUpgradeable {
    ...
    function initialize() public initializer {
        ...
        ERC721Upgradeable.__ERC721_init("Rubber Duck Bath Party", "RDBP");
        price = 0.08 ether;
        mintActive = false;
    ...
    function ownerMint(address _to, uint256 _mintAmount) public onlyOwner {
        ...
        require(
            addressMintedBalance[msg.sender] + _mintAmount <= ownerMintLimit,
            "max ducks for team exceeded"
        );
